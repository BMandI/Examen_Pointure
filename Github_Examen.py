...
# METTRE STR AVANT POUR CONVERTIR EN STRING
with open('modele.txt', 'a') as fout:
  fout.write(str(lm.intercept_))
  fout.write(str(lm.coef_[0]))
  fout.write(str(lm.coef_[1]))
  fout.write(str(lm.coef_[2]))
